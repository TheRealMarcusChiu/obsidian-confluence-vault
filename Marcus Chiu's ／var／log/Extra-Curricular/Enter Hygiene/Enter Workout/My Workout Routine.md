...
>     [
>       {
>         "content": "Switch between the following two",
>         "header": true,
>         "bg": "#F4F5F7",
>         "colspan": 2
>       },
...
> - <strong>Day 4:</strong> Push (variation)
> - <strong>Day 5:</strong> Pull (variation)
> - <strong>Day 6:</strong> Legs + Abs (variation)
...
>     [
>       {
>         "content": "<strong>💥 Day 1 – PUSH (Strength Focus)</strong>\n\n<strong>Goal:</strong> Build thick chest + shoulders",
>         "bg": "#F4F5F7"
>       },
...
>     [
>       {
>         "content": "<strong>💪 Day 2 – PULL (Width Focus)</strong>\n\n<strong>Goal:</strong> Wide V-taper",
>         "bg": "#F4F5F7"
>       },
...
>     [
>       {
>         "content": "<strong>🦵 Day 3 – LEGS + ABS</strong>\n\n<strong>Goal:</strong> Strong base + visible abs",
>         "bg": "#F4F5F7"
>       },
...
>     [
>       {
>         "content": "<strong>🔥 Day 4 – PUSH (Hypertrophy Focus)</strong>\n\n<strong>Goal:</strong> Shape + definition",
>         "bg": "#F4F5F7"
>       },
...
>     [
>       {
>         "content": "<strong>💪 Day 5 – PULL (Thickness Focus)</strong>\n\n<strong>Goal:</strong> Dense back",
>         "bg": "#F4F5F7"
>       },
...
>     [
>       {
>         "content": "<strong>🦵 Day 6 – LEGS + ABS (Hypertrophy)</strong>\n\n<strong>Goal:</strong> Detail + symmetry",
>         "bg": "#F4F5F7"
>       },
...
>     [
>       {
>         "content": "<strong>Exercise Type</strong>",
>         "bg": "#F4F5F7"
>       },
>       {
...
>       },
>       {
>         "content": "<strong>RPE (Intensity)</strong>",
>         "bg": "#F4F5F7"
>       }
>     ],
>     [
>       {
>         "content": "Heavy Overhead Press",
>         "bg": "#F4F5F7"
>       },
>       "3–4",
>       "6–10",
...
>     [
>       {
>         "content": "Lateral Raise (Isolation)",
>         "bg": "#F4F5F7"
>       },
>       "3–5",
>       "12–20",
...
>       },
>       {
>         "content": "<strong>Focus</strong>",
>         "bg": "#F4F5F7"
>       }
>     ],
>     [
>       {
>         "content": "Heavy Compound (Pull-ups/Rows)",
>         "bg": "#F4F5F7"
>       },
>       "6–10",
>       "3–4",
...
>     [
>       {
>         "content": "Moderate Isolation (Pulldowns)",
>         "bg": "#F4F5F7"
>       },
>       "12–15",
>       "3",
...
>     [
>       {
>         "content": "High Rep Finisher (Straight-Arm)",
>         "bg": "#F4F5F7"
>       },
>       "20+",
>       "2",
...
>     [
>       {
>         "content": "<strong>Movement Type</strong>",
>         "bg": "#F4F5F7"
>       },
>       {
>         "content": "<strong>Sets</strong>",
...
>       },
>       {
>         "content": "<strong>Rest</strong>",
>         "bg": "#F4F5F7"
>       }
>     ],
>     [
>       {
>         "content": "Heavy Incline Press",
>         "bg": "#F4F5F7"
>       },
>       "3–4",
>       "6–10",
