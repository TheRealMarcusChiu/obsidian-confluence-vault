...
```merge-table
{
  "rows": [
    ...
    [
      {
        "content": "2-ary Relation",
        "bg": "#F4F5F7"
      },
      "[[Binary Relation (Correspondence ／ Dyadic Relation ／ 2-Place Relation)|Binary Relation (Correspondence / Dyadic Relation / 2-Place Relation)]]"
    ],
    [
      {
        "content": "3-ary Relation",
        "bg": "#F4F5F7"
      },
      "Ternary Relation"
    ],
