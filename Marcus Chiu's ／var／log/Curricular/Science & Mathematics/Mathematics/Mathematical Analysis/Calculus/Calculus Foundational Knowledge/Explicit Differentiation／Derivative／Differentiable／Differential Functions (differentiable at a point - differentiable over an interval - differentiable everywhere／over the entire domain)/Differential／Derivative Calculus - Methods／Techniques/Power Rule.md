---
created: 2023-08-10T12:05:47.928-05:00
modified: 2023-08-22T18:22:54.991-05:00
...
- $\frac{df}{dx} = \frac{(x + dx)^2 - x^2}{dx}$
- $\frac{df}{dx} = \frac{x^2 + 2xdx + dx^2 - x^2}{dx}$
- $\frac{df}{dx} = \frac{2xdx + dx^2}{dx}$
- $\frac{df}{dx} = 2x + dx$
- $\frac{df}{dx} = 2x$
