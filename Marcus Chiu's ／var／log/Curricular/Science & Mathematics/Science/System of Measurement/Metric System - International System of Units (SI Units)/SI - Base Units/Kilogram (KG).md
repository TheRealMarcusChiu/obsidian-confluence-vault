...
- <strong>2019</strong>: The kilogram was [defined](https://en.wikipedia.org/wiki/2019_redefinition_of_the_SI_base_units) in terms of the [Planck constant](https://en.wikipedia.org/wiki/Planck_constant), the [speed of light](https://en.wikipedia.org/wiki/Speed_of_light), and the [hyperfine transition frequency of <sup>133</sup>Cs](https://en.wikipedia.org/wiki/Caesium_standard) as approved by the [General Conference on Weights and Measures](https://en.wikipedia.org/wiki/General_Conference_on_Weights_and_Measures) (CGPM) on November 16, 2018.
