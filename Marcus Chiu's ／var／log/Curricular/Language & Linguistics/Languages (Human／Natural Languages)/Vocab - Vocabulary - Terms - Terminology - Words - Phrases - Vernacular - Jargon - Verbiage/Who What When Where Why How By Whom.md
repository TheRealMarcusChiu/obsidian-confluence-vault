...
- <strong>where</strong> - is it to be done (destination)
- <strong>why</strong> - is it to be done (reason)
- <strong>how</strong> - is it to be done (implementation)
- <strong>by whom</strong> - is doing the what
