---
created: 2019-03-15T17:36:27.829-05:00
modified: 2022-09-18T03:10:13.333-05:00
parent: "[[Java Platform]]"
children:
  - "[[Java - Archive File Formats (JAR - WAR - EAR)]]"
  - "[[Java - Binary Tools]]"
  - "[[Java - Build Tools]]"
  - "[[Java - Installation (JDK - JRE - JVM - JE - JSE - JEE - JME)]]"
  ...
  - "[[Java - Underneath]]"
  - "[[Java - Versions]]"
  - "[[Java - Vulnerabilities／Vulnerability／Bugs／Bug]]"
  - "[[Java Object Layout (JOL)]]"
---
###### Java
````excerpt
- is a [[Computer／Programming Languages|programming language]] that is concurrent, class-based, and [[Object-Oriented Programming|object-oriented]]
...
- [[Java - Archive File Formats (JAR - WAR - EAR)]]
- [[Java - Profilers／Profiling-Tools|Java - Profilers/Profiling-Tools]]
- [[Java Object Layout (JOL)]]
...
- Java Network Programming [pdf](http://it.guldstadsgymnasiet.se/java/Java%20Network%20Programming,%204th%20Edition.pdf)
- Java Design Patterns [pdf](http://enos.itcollege.ee/~jpoial/java/naited/Java-Design-Patterns.pdf)
