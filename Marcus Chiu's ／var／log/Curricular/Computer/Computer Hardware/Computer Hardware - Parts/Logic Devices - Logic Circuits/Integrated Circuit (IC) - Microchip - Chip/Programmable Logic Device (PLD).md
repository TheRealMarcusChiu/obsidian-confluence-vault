...
```merge-table
{
  "rows": [
    [
      {
        "content": "[[Programming Array Logic (PAL) - Programmable Logic Array (PLA)|Programming Array Logic (PAL)Programmable Logic Array (PLA)]]",
        "header": true,
        "bg": "#F4F5F7"
      },
      "least complex"
    ...
    [
      {
        "content": "[[Complex Programmable Logic Device (CPLD)]]",
        "header": true,
        "bg": "#F4F5F7"
      },
      "middle complex"
    ...
    [
      {
        "content": "[[Field-Programmable Gate Arrays (FPGA)]]",
        "header": true,
        "bg": "#F4F5F7"
      },
      "most complex"
