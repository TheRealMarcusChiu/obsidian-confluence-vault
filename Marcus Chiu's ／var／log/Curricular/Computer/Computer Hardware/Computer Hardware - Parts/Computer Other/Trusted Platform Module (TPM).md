---
created: 2023-04-21T20:05:01.790-05:00
modified: 2024-06-29T23:38:22.241-05:00
parent: "[[Computer Other]]"
children: []
---
###### Trusted Platform Module (TPM)
````excerpt
- is designed to provide hardware-based, security-related functions
...
- usually found on [[Motherboard (MoBo)|motherboard]] or [[Central Processing Unit (CPU) - Central／Main Processor - Microprocessor (uP) - Microcontroller (uC) - Microcontroller Unit (MCU)|CPU]]
````
^excerpt
