---
created: 2019-03-16T03:03:48.361-05:00
modified: 2023-05-11T19:15:33.812-05:00
parent: "[[Network／Protocol／Packet Analyzer／Sniffer]]"
children:
  - "[[Wireshark - GUI Application]]"
  - "[[Wireshark - Terminal]]"
---
###### Wireshark (Ethereal) [www.wireshark.org](http://www.wireshark.org/)
````excerpt
...
- it is used for network troubleshooting, analysis, software, communications protocol development, and education
````
^excerpt
