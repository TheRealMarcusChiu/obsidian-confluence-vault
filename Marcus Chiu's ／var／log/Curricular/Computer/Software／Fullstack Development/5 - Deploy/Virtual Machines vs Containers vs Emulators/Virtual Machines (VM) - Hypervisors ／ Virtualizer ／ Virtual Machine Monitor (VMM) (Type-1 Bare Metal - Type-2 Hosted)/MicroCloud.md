---
created: 2026-01-12T00:44:43.707-06:00
modified: 2026-01-12T00:45:28.909-06:00
parent: "[[Virtual Machines (VM) - Hypervisors ／ Virtualizer ／ Virtual Machine Monitor (VMM) (Type-1 Bare Metal - Type-2 Hosted)]]"
children: []
---
###### MicroCloud
````excerpt
- similar to [[Proxmox Virtual Environment (PVE)|Proxmox]]
````
^excerpt

# Introduction

![](https://www.youtube.com/watch?v=tSJqjZjLrig)
# Resources
