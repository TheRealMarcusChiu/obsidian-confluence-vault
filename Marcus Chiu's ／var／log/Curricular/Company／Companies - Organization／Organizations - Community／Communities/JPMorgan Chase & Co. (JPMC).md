...
```merge-table
{
  "rows": [
    [
      {
        "content": "JPMorgan Chase Business Segment",
        "header": true,
        "bg": "#F4F5F7"
      },
      {
...
<font style="color: rgb(128,128,128);">NET INCOME AND RETURN ON EQUITY FOR THIRD-QUARTER 2017</font>
